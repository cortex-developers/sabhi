        ...
        <Routes>
          <Route path="/" element={
            <div>
              ...
              <Container maxWidth="lg" style={{ marginTop: '40px', marginBottom: '20px' }}>
                <Typography variant="h4" component="p" style={{ textAlign: 'center', marginBottom: '20px' }}>
                  Connect With Us
                </Typography>
                <Grid container spacing={4} justifyContent="center">
                  <Grid item xs={12} sm={6}>
                    <Typography variant="h6" style={{ marginBottom: '10px' }}>Follow us on Instagram</Typography>
                    
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <Typography variant="h6" style={{ marginBottom: '10px' }}>Follow us on Twitter</Typography>
                  </Grid>
                </Grid>
              </Container>
              */}
